...
-- Erstellungszeit: 19. Mrz 2026 um 19:12
...
ALTER TABLE `videos`
  ...
  ADD KEY `fk_videos_user` (`username`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `fk_comments_video_id` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`);
...
--
ALTER TABLE `videos`
  ADD CONSTRAINT `fk_videos_user` FOREIGN KEY (`username`) REFERENCES `user` (`username`);
COMMIT;
